...
public interface PerformanceRepository extends JpaRepository<Performance, Long> {
    ...
    /* 해당 날짜의 예약 가능한 특정 공연들 정보 조회(날짜 오름차순) */
    ...
    /* 해당 날짜의 특정 공연 정보 조회 */
    Optional<Performance> findByTitleAndStartDateLessThanEqualAndEndDateGreaterThanEqual(String title, LocalDate startDate, LocalDate endDate);
}